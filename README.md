...
<br />
<b>
دقت کنید که میزان دسترسی های سی‌ام‌دی باز شده آنقدر زیاد است که میتواند فایل های پوشه ی Windows را نیز حذف کند و در صورت استفاده ی نابجا ممکن است خسارت جبران ناپذیری به بار بیاورد!
</b>
<h3 dir="rtl">چطور تبدیل به تراستد اینتس</h3>
