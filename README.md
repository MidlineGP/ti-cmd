...
<br/><br/>
برای نصب و استفاده از این برنامه کافیست آخرین نسخه ی ی‌آی سی‌ام‌دی را از <a href="https://code.midline.ir/ti-cmd/releases/latest/ti-cmd.exe">این لینک</a> دانلود کرده و بعد آن را باز کنید، از شما خواسته میشود که دسترسی ادمین را به برنامه بدهید و بعد باقی مراحل بصورت خودکار باز میشود.
<br/><br/>
در صورت موفقیت آمیز بودن عملیات یک سی‌ام‌دی باز میشود، برای مطمین شدن از اینکه ترمینال دسترسی تراستد اینستالر را دارد یا نه کافیست دستور زیر را وارد کنید و باید با تصویر بالای صفحه روبرو شوید :
</div>
...
<br/><br/>
در صورت تمایل به تبدیل فایل ویرایش شده ی خود به فایل اجرایی، میتوانید ابتدا یک پاور شل را با دسترسی ادمین باز کرده و سپس ماژول ps2exe را از با اجرای دستور زیر در آن نصب کنید :
</div>
