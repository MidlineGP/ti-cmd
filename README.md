...
<br/><br/>
برای نصب و استفاده از این برنامه کافیست آخرین نسخه ی تی‌آی سی‌ام‌دی را از <a href="https://github.com/MidlineGP/ti-cmd/releases/latest/download/ti-cmd.exe">این لینک</a> دانلود کرده و بعد آن را باز کنید، از شما خواسته میشود که دسترسی ادمین را به برنامه بدهید و بعد باقی مراحل بصورت خودکار انجام میشود.
<br/><br/>
